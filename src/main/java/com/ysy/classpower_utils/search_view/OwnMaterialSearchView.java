 ...
 */
public class OwnMaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public OwnMaterialSearchView(Context context) {
        this(context, null);
    }

    public OwnMaterialSearchView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OwnMaterialSearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mUserQuery = s;
                startFilter(s);
                OwnMaterialSearchView.this.onTextChanged(s);
            }
    ...
    private void startFilter(CharSequence s) {
        if (mAdapter != null && mAdapter instanceof Filterable) {
            ((Filterable) mAdapter).getFilter().filter(s, OwnMaterialSearchView.this);
        }
    }
    ...
    public void setSuggestions(String[] suggestions) {
        if (suggestions != null && suggestions.length > 0) {
            ...
            final OwnSearchViewAdapter adapter = new OwnSearchViewAdapter(mContext, suggestions, suggestionIcon, ellipsize);
            setAdapter(adapter);
