...
public abstract class MaterialButton extends CustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(MaterialButtonUtils.dpToPx(minHeight, getResources()));
		setMinimumWidth(MaterialButtonUtils.dpToPx(minWidth, getResources()));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - MaterialButtonUtils.dpToPx(6, getResources()), getHeight()
						- MaterialButtonUtils.dpToPx(7, getResources()), Config.ARGB_8888);
