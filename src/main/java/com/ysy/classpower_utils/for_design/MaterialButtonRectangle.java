...
public class MaterialButtonRectangle extends MaterialButton {
	...
	public MaterialButtonRectangle(Context context, AttributeSet attrs) {
		super(context, attrs);
		setDefaultProperties();
	}
	@Override
	protected void setDefaultProperties(){
//		paddingBottom = MaterialButtonUtils.dpToPx(16, getResources());
//		paddingLeft = MaterialButtonUtils.dpToPx(16, getResources());
//		paddingRight = MaterialButtonUtils.dpToPx(16, getResources());
//		paddingTop = MaterialButtonUtils.dpToPx(16, getResources());
		super.minWidth = 80;
		super.minHeight = 36;
...
//			paddingBottom = MaterialButtonUtils.dpToPx(padding, getResources());
//			paddingLeft = MaterialButtonUtils.dpToPx(padding, getResources());
//			paddingRight = MaterialButtonUtils.dpToPx(padding, getResources());
//			paddingTop = MaterialButtonUtils.dpToPx(padding, getResources());
//		}else{
...
//		}
		...
		if(text != null){
			...
			params.setMargins(MaterialButtonUtils.dpToPx(5, getResources()), MaterialButtonUtils.dpToPx(5, getResources()), MaterialButtonUtils.dpToPx(5, getResources()), MaterialButtonUtils.dpToPx(5, getResources()));
...
//					textView.setLayoutParams(params);textColor
		...
		rippleSpeed = attrs.getAttributeFloatValue(MATERIALDESIGNXML,
				"rippleSpeed", MaterialButtonUtils.dpToPx(6, getResources()));
	}
...
//		if((textButton.getWidth()+paddingLeft+paddingRight)>MaterialButtonUtils.dpToPx(80, getResources()))
...
//		centrarTexto();
		super.onDraw(canvas);
		if (x != -1) {
			Rect src = new Rect(0, 0, getWidth()- MaterialButtonUtils.dpToPx(6, getResources()), getHeight()- MaterialButtonUtils.dpToPx(7, getResources()));
			Rect dst = new Rect(MaterialButtonUtils.dpToPx(6, getResources()), MaterialButtonUtils.dpToPx(6, getResources()), getWidth()- MaterialButtonUtils.dpToPx(6, getResources()), getHeight()- MaterialButtonUtils.dpToPx(7, getResources()));
