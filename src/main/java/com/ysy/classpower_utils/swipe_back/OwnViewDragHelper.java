...
/**
 * OwnViewDragHelper is a utility class for writing custom ViewGroups. It offers a
 ...
 */
public class OwnViewDragHelper {
    private static final String TAG = "OwnViewDragHelper";
    ...
    /**
     * A Callback is used as a communication channel with the OwnViewDragHelper
     ...
     * the OwnViewDragHelper with more information about the state of the parent
    ...
    public static abstract class Callback {
         ...
         * invokes one of these methods, the OwnViewDragHelper will enter
         ...
         * place and the OwnViewDragHelper will return to {@link #STATE_IDLE}.
         * </p>
         *
         ...
         * <p>
         * OwnViewDragHelper may call this method multiple times for the same view
     ...
     * @return a new OwnViewDragHelper instance
     */
    public static OwnViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final OwnViewDragHelper helper = create(forParent, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }

    /**
     * Apps should use OwnViewDragHelper.create() to get a new instance. This will
     ...
     * @param forParent Parent view to monitor
     */
    private OwnViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
     ...
     * callback's
     * {@link OwnViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link OwnViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link OwnViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
    ...
    public void captureChildView(View childView, int activePointerId) {
        if (childView.getParent() != mParentView) {
            throw new IllegalArgumentException("captureChildView: parameter must be a descendant "
                    + "of the OwnViewDragHelper's tracked parent view (" + mParentView + ")");
        }
     ...
     * (to the best of the OwnViewDragHelper's knowledge).
     * <p>
     ...
     * {@link OwnViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
